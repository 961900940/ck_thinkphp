...
CREATE TABLE `ks_article_category` (
  ...
  PRIMARY KEY (`cid`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='文章内容分类';
INSERT INTO `ks_article_category` VALUES ( '1', '小说', '2016-08-18 15:55:05', '2016-08-18 22:41:09');
