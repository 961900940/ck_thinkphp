...
<div class="navArea">
    <div class="userInfo">
        ...
        欢迎您，a@a.com
                    ...
                    <div class="nav">
                        <font id="today"></font>您的位置：权限管理 > 添加编辑节点
                    </div>
                </div>
            </div>
            <div class="clear"></div>
        ...
        <?php if(is_array($MenuItem)): foreach($MenuItem as $key=>$vo): ?><li><a href="/ck_thinkphp/index.php/Admin/<?php echo ($vo["auth_c"]); ?>/<?php echo ($vo["auth_a"]); ?>"><?php echo ($vo["auth_name"]); ?></a></li><?php endforeach; endif; ?>
                ...
                <div id="Right">
                    <div class="contentArea">
                        <div class="Item hr">
                            <div class="current">添加编辑节点</div></div>
                        <form action="" method="post">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                                <tr>
                                    <th width="120">名称：</th>
                                    <td>
                                        <input name="name" type="text" class="input" size="40" value="" />英文，为MODEL_NAME的时候首字母大写</td></tr>
                                <tr>
                                    <th>显示名：</th>
                                    <td>
                                        <input class="input" name="title" type="text" size="40" value="" />中英文均可</td></tr>
                                <tr>
                                    <th>状态：</th>
                                    <td>
                                        <select name="status" style="width: 80px;">
                                            <option value="1">启用</option>
                                            <option value="0" selected>禁用</option></select>如果禁用那么只有超级管理员才可以访问，其他用户都无权访问</td>
                                </tr>
                                <tr>
                                    <th>类型：</th>
                                    <td>
                                        <select name="level" style="min-width: 80px;">
                                            <option value="1" selected='selected'>项目</option>
                                            <option value="2">模块</option>
                                            <option value="3">操作</option></select>项目（GROUP_NAME; 模块(MODEL_NAME); 操作（ACTION_NAME）</td>
                                </tr>
                                <tr>
                                    <th>父级节点：</th>
                                    <td>
                                        <select name="pid" style="min-width: 80px;">
                                            ...
                                            <option value="1" level="1">后台管理</option>
