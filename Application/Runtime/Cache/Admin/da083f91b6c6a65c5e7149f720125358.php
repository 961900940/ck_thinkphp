...
<div class="navArea">
    <div class="userInfo">
        ...
        欢迎您，a@a.com
                ...
                <div class="nav">
                    <font id="today"></font>您的位置：权限管理 > 添加编辑角色</div>
            </div>
        </div>
        <div class="clear"></div>
        <div class="mainBody">
                    ...
                    <form action="/ck_thinkphp/index.php/Admin/Access/editRole?id=3" method="post">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            <tr>
                                ...
                                <td>
                                    <input name="role_name" type="text" class="input" size="40" value="<?php echo ($role_info['role_name']); ?>" /></td>
                            </tr>
                            <tr>
                                <th>状态：</th>
                                <td>
                                    <select name="status" style="width: 80px;">
                                        <option value="1" <?php if($role_info["status"] == 1): ?>selected="selected"<?php endif; ?> >启用</option>
                                        <option value="0" <?php if($role_info["status"] == 0): ?>selected="selected"<?php endif; ?> >禁用</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <th>描 述：</th>
                                <td>
                                    <textarea name="remark" style="width: 400px;"><?php echo ($role_info["remark"]); ?></textarea></td>
                            </tr>
                        </table>
                        <input type="hidden" name="id" value="<?php echo ($role_info["role_id"]); ?>" />
                    </form>
