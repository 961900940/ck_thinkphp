...
<body>
    <xmp>
    1、URL模式(tp3.2版本的标准格式)：URL_MODEL： 0 1 2 3
    http://serverName/index.php/模块/控制器/操作
    0 普通模式也就是传统的GET传参方式来指定当前访问的模块和操作:
    ...
    http://localhost/index.php/home/user/login/var/value/ PATHINFO地址的前三个参数分别表示模块/控制器/操作。
        ...
        // 更改PATHINFO参数分隔符
        'URL_PATHINFO_DEPR'=>'-',
    2 REWRITE模式是在PATHINFO模式的基础上添加了重写规则的支持，可以去掉URL地址里面的入口文件index.php，但是需要额外配置WEB服务器的重写规则:
    ...
    <xmp>
    3 兼容模式是用于不支持PATHINFO的特殊环境，URL地址是： http://localhost/?s=/home/user/login/var/value
