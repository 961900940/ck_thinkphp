...
<body>
    ...
    <ul id="apiTree" class="mini-tree" showTreeIcon="true" style="width:100%;height:100%;" enableHotTrack="false" onbeforeexpand="onBeforeExpand">
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="<?php echo U('Index/database_statement_1');?>" target="main">tip</a></li>
                <li>    
                    <a href="<?php echo U('Index/database_statement_2');?>" target="main">mysql</a></li>
                <li>    
                    <a href="<?php echo U('Index/database_statement_3');?>" target="main">mysqli</a></li>
                <li>    
                    <a href="<?php echo U('Index/database_statement_4');?>" target="main">pdo</a></li>
            </ul>
        </li>
        <li>
            <span expanded="false">Apache配置<span style="color:Red;">New!</span></span>
            <ul>
                <li>
